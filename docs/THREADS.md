...
- 2026-09-24 — #25 closed: `docs/screenshot.png` retaken once codex answered again, on a throwaway instance — the lanes now read Claude Opus 5.5, GPT-6 Astra, Kimi K3 and Grok 4.7.
