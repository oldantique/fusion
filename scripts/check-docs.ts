...
const DOCS = ["README.md", "CLAUDE.md", "CHANGELOG.md", "docs/DESIGN.md", "docs/RUNBOOK.md", "docs/THREADS.md", "fixtures/README.md", "deploy/fusion.service"];
const PATH_ROOTS = ["src", "web", "scripts", "tests", "fixtures", "deploy", "docs", "data"];
const ROOT_FILES = ["README.md", "CLAUDE.md", "CHANGELOG.md", "LICENSE", "package.json", "tsconfig.json", ".env", ".env.example", ".gitignore"];
