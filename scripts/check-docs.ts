...
const DOCS = ["README.md", "CLAUDE.md", "CHANGELOG.md", "docs/DESIGN.md", "docs/RUNBOOK.md", "docs/THREADS.md", "fixtures/README.md", "deploy/fusion.service", ".claude/skills/sync-docs/SKILL.md"];
